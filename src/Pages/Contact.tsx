    ...
    return(
        <div className='contact section bg-white flex justify-center lg:block'>
          <h2 className='section-header text-center lg:hidden'>Contact me!</h2>
            <div className="min-h-[80%] absolute width-[100vw] flex flex-col justify-center items-center xxs:pt-[7.5vh] lg:relative lg:flex-row">
              <div className='flex flex-col py-16 xxs:py-[7.5vh] lg:p-8 lg:flex-row'>
                ...
                <span className='text-xl xxs:text-2xl sm:text-3xl md:text-4xl text-center lg:text-2xl lg:py-2 lg:px-4'>139 131 222</span>
              </div>
              <div className='flex flex-col py-8 xxs:py-[7.5vh] lg:p-8 lg:flex-row'>
                ...
                <span className='text-xl xxs:text-2xl sm:text-3xl md:text-4xl lg:text-2xl lg:py-2 lg:px-4 text-center'>xavier@gmail.com</span>
              </div>
            </div>
        </div>
        )
