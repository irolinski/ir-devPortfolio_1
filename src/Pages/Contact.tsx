  ...
  return (
    ...
    >
      ...
      <div className="width-[100vw] absolute flex min-h-[90%] flex-col items-center justify-center xxs:min-h-[80%] xxs:pt-[15vh] md:pt-[7.5vh] lg:relative lg:flex-row">
        ...
        transition={{ type: "spring", delay: 0.2, duration: 0.8 }} className="flex flex-col py-16 xxs:py-[7.5vh] lg:flex-row lg:p-8">
        ...
        whileInView={{ translateX: 0, opacity: 1 }}
        viewport={{ once: false, amount: 0.5 }}
        transition={{ type: "spring", delay: 0.2, duration: 0.4 }} className="flex flex-col py-8 xxs:py-[7.5vh] lg:flex-row lg:p-8">
